                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end locale-selector" aria-labelledby="langDropdown">
                            ...
                            <a class="dropdown-item" data-locale="pt-br" href="https://GYM.One.com/pt-br/">
                                <img src="https://GYM.One.com/assets/svg/country/br.svg" class="svg"
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-md-7 offset-md-2">
                <h1 class="display-3 fw-semibold mb-4">Download GYM.One</h1>
                ...
                <a href="https://github.com/GYM.One/GYM.OneInstaller/releases/latest/download/GYM.OneInstaller.zip"
                    ...
                    <span class="version">GYM.One v1.1.10</span>
                </a>
            </div>
        </div>
        <!-- FOOTER -->
