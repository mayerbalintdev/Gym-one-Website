...
<body>
  ...
  <div class="container">
    <div class="row text-center">
      ...
      <div class="row text-center">
        <div class="col">
          <a class="btn btn-primary pulse" href="download/" role="button"><?php echo $translations['downloadbtn']; ?><i class="bi bi-rocket-takeoff"></i></a>
          <a class="btn btn-secondary" href="#info" role="button"><i class="bi bi-rocket"></i><?php echo $translations['secondbtn']; ?></a>
        </div>
      </div>
      <div class="row">
        <div class="col">
      ...
      <section id="community">
        <div class="row gy-4 justify-content-between text-start">
          <div class="col-md-5 align-self-center">
            <img src="https://GYM.One.com/assets/img/theme.png" alt="Theme" class="img-fluid image-3d rounded-3" width="700" height="474">
          </div>
