...
<title>GYM One - <?php echo $translations['contactpage']; ?></title>
...
<body>
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-md-8 mx-auto text-center mb-5">
                <h1 class="mb-3 fw-semibold"><?php echo $translations["youwantcontact"]; ?></h1>
            </div>
            <div class="row">
                <div class="col">
    ...
    <section id="info">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-sm-12 text-xl-start text-sm-center">
                    <h1 class="lead fw-semibold">GYM One - Center</h1>
                    <small><?php echo $translations["contactcenter"]; ?></small>
                    <p class="lead">📧 <a href="mailto:center@gymoneglobal.com">center@gymoneglobal.com</a></p>
                </div>
                <div class="col-xl-4 col-sm-12 text-xl-start text-sm-center">
                    <h1 class="lead fw-semibold">GYM One - Info</h1>
                    <small><?php echo $translations["contactinfo"]; ?></small>
                    <p class="lead">📧 <a href="mailto:info@gymoneglobal.com">info@gymoneglobal.com</a></p>
                </div>
                <div class="col-xl-4 col-sm-12 text-xl-start text-sm-center">
                    <h1 class="lead fw-semibold">GYM One - Marketing</h1>
                    <small><?php echo $translations["contactmarketing"]; ?></small>
                    <p class="lead">📧 <a href="mailto:marketing@gymoneglobal.com">marketing@gymoneglobal.com</a></p>
                </div>
            </div>
    </section>
    <!-- FOOTER -->
