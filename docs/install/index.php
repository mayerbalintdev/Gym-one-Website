...
<meta property="og:url" content="http://gymoneglobal.com/docs">
        ...
        <div class="row">
            ...
            <main class="col-md-9 col-xl-9 markdown-content">
                ...
                <ul>
                    ...
                    <li>Calendar PHP <?php echo $translations["extension"]; ?></li>
                    <li>Random PHP <?php echo $translations["extension"]; ?></li>
                    <li>Readline PHP <?php echo $translations["extension"]; ?></li>
                    <li>Mysqlnd PHP <?php echo $translations["extension"]; ?></li>
                    <li>Bz2 PHP <?php echo $translations["extension"]; ?></li>
                    <li>Simplexml PHP <?php echo $translations["extension"]; ?></li>
                    <li>Apache2handler PHP <?php echo $translations["extension"]; ?></li>
                    <li>OpenSSL PHP <?php echo $translations["extension"]; ?></li>
                    <li>Curl PHP <?php echo $translations["extension"]; ?></li>
                    <li>Fileinfo PHP <?php echo $translations["extension"]; ?></li>
                    <li>Gd PHP <?php echo $translations["extension"]; ?></li>
                    <li>Gettext PHP <?php echo $translations["extension"]; ?></li>
                    <li>Mbstring PHP <?php echo $translations["extension"]; ?></li>
                    <li>Exif PHP <?php echo $translations["extension"]; ?></li>
                    <li>Mysqli PHP <?php echo $translations["extension"]; ?></li>
                    <li>Pdo_mysql PHP <?php echo $translations["extension"]; ?></li>
                    <li>Pdo_sqlite PHP <?php echo $translations["extension"]; ?></li>
                    <li>Phar PHP <?php echo $translations["extension"]; ?></li>
                    <li>Ftp PHP <?php echo $translations["extension"]; ?></li>
...
sudo mysql_secure_installation
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <pre tabindex="0"><code>chmod -R 777 /var/www/gymone</code></pre>
                        <p>
