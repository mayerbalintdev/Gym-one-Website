    ...
    <main class="container content">
        ...
        <div class="row">
            ...
            <main class="col-md-9 col-xl-9 markdown-content">
                ...
                <a class="btn btn-primary" href="../../assets/docs/TOS.pdf">
                ...
                <a class="btn btn-primary" href="../../assets/docs/LD.pdf">
                    <h6><?php echo $translations["docsbtn"]; ?></h6>
                </a>
                <h2 id="IP">
                ...
                <a class="btn btn-primary" href="../../assets/docs/IP.pdf">
                    <h6><?php echo $translations["docsbtn"]; ?></h6>
                </a>
                <h2 id="PP">
                ...
                <a class="btn btn-primary" href="../../assets/docs/PP.pdf">
                    <h6><?php echo $translations["docsbtn"]; ?></h6>
                </a>
                <h2 id="LICENSE">
