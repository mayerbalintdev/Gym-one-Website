...
$servername = "134.209.240.138";
$username = "webhost";
$password = "pinaporkolt";
$dbname = "gymoneweb";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO mail_sub (Email, Fullname, GYMname) VALUES ('$email', '$fullName', '$gymname')";

    $conn->query($sql);
    $conn->close();

    $transport = (new \Swift_SmtpTransport('smtp.zoho.eu', 587, 'tls'))
        ->setUsername('no-reply@gymoneglobal.com')
        ->setPassword('Mestermc2019.');
    ...
    <body>
        <div class='email-container'>
            <div class='logo-container'>
                <img src='https://www.gymoneglobal.com/assets/img/text-color-logo.png' alt='GYM One Logo'>
            </div>

            <div class='email-content'>
                <h1>" . $translations["demo-emailprereg"] . "</h1>
                <p>" . $translations["dear"] . " $fullName,</p>
                <p>" . $translations["demo-emailfirst"] . "</p>
                <p>" . $translations["demo-emailsecond"] . "</p>
                <p>" . $translations["bestregards"] . "<br>" . $translations["thegymoneteam"] . "</p>
            </div>

            <div class='footer'>
                © " . $currentYear . " GYM One. " . $translations["copyright"] . "
            </div>
        </div>
    </body>
    </html>";

    $message = (new \Swift_Message($translations["demo-emailprereg"]))
        ->setFrom(['no-reply@gymoneglobal.com' => 'GYM One'])
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>GYM One - <?php echo $translations['demoprereg']; ?></title>
...
<meta name="twitter:title" content="Pre Register">
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-md-8 mx-auto text-center mb-5">
                <h1 class="mb-3 fw-semibold"><?php echo $translations["demohero"]; ?></h1>
                <h2 class="lead mb-4 fs-4"><?php echo $translations['demoherotext']; ?></h2>
            </div>
            <div class="row text-center">
                <div class="col">
                    <a class="btn btn-primary pulse mx-2 mb-4" href="#community"
                        role="button"><?php echo $translations['demoregister']; ?></a>
                </div>
            </div>
            <div class="row">
                <div class="col">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-sm-12 text-start">
                    ...
                    <h2 class="display-6 my-3 fw-semibold">
                        <?php echo $translations["demofirsttext"]; ?>
                    </h2>
                </div>
                <div class="col-xl-5 col-sm-12 align-self-center">
                    <div class="d-flex align-items-center mb-2 border rounded p-3">
                        ...
                        <p class="flex-grow-1 ms-3 mb-0">
                            <?php echo $translations["demo_one-benefit"]; ?>
                        </p>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-2 border rounded p-3">
                        ...
                        <p class="flex-grow-1 ms-3 mb-0">
                            <?php echo $translations["demo_two-benefit"]; ?>
                        </p>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-2 border rounded p-3">
                        ...
                        <p class="flex-grow-1 ms-3 mb-0">
                            <?php echo $translations["demo_three-benefit"]; ?>
                        </p>
                    </div>
            ...
            <div class="row gy-4 justify-content-center text-start">
                <div class="col-sm-6">
                    <div class="form-container">
                        <form id="preRegistrationForm" action="" method="POST" class="p-3 bg-light rounded shadow">
                            <div class="form-group mb-3">
                                <label for="fullName" class="form-label text-dark"><?php echo $translations["fullname"]; ?></label>
                                <input type="text" class="form-control form-control-lg" name="fullName" id="fullName" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="email" class="form-label text-dark"><?php echo $translations["email"]; ?></label>
                                <input type="email" class="form-control form-control-lg" name="email" id="email" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="gymName" class="form-label text-dark"><?php echo $translations["gym-name"]; ?> <?= $translations["optional"]; ?></label>
                                <input type="text" class="form-control form-control-lg" name="gymName" id="gymName">
                            </div>
                            <div class="form-group mb-4">
                                <label for="role" class="form-label text-dark"><?= $translations["roleingym"]; ?></label>
                                <select class="form-select form-select-lg" name="role" id="role" required>
                                    <option value=""><?php echo $translations["categoryselect"]; ?></option>
                                    <option value="Owner"><?php echo $translations["owner"]; ?></option>
                                    <option value="Trainer"><?php echo $translations["trainer"]; ?></option>
                                    <option value="Manager"><?php echo $translations["manager"]; ?></option>
                                </select>
                            </div>
                            <button type="submit" class="btn btn-primary btn-lg w-100"><?= $translations["registerbtn"]; ?></button>
                        </form>
